    ...
    constructor( instance ) {
        ...
        this.deriveTypeOpts = {
            ...
            options: [
                ...
                { deriveType: 'Differential w/ Tags', description: `Add the features from ${Hoot.config.secondaryLabel} that don't exist in ${Hoot.config.referenceLabel} including tags` }
            ]
        };
