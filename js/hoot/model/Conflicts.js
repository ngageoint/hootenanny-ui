...
Hoot.model.conflicts = function( context ) {
    ...
    */
    ...
    var processMerge = function( reviewRefs, mapid, queryElement1, queryElement2, featureToDelete, mergedNode, reviewMergeRelationId ) {
        try {
            if ( reviewRefs ) {
...
//
     ...
     */
    model_conflicts.autoMergeFeature = function( feature, featureAgainst, mapid, reviewMergeRelationId, callback ) {
        try {
