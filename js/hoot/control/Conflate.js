        ...
        fieldset.selectAll('.form-field')
            ...
            .html(function (field) {
                if(field.type==='ConfType'){
                    var retval = '';
                    retval += '<div style="opacity: 1;"><label class="pad1x pad0y strong fill-light round-top keyline-bottom" style="opacity: 1; max-width: 62%; display: inline-block; width: 90%;">';
                    retval += field.label;
                    retval += '</label><span class="pad1x pad0y dark quiet fr fill-light round-top keyline-bottom" style="opacity: 1; display: inline-block; width: 38%;">Advanced Options</span><a id="confAdvOptsLnk" class="button pad1x pad0y strong fill-light round-top keyline-bottom" href="#" style="opacity: 1; max-width: 10%; display: inline-block; position: absolute;">►</a></div>';
                    return retval;
                } else {
