...
Hoot.view.utilities.reviewbookmarks = function( context ) {
    ...
    var _createMenu = function( form, menuDivName, displayText, meta, menuContainer ) {
        ...
        _.each( meta.data, function( c ) {
            ...
            if ( this.type === 'radio' ) {
                filterInput.attr( 'name', 'sortByFilter' ).classed( 'sortByFilter', true );
            }
    ...
    _instance.addFilter = function( container, filter ) {
        ...
        if ( usedIds.indexOf( filter.id ) >= 0 ) {
            return;
        }
        ...
        var data   = [
            ...
            },
            {
                'name': 'Created At (dsc)', 'action': function() {
                    _sortData( 'createdAt', 'false' );
                }
            },
            {
                'name': 'Created By (asc)', 'action': function() {
                    _sortData( 'createdBy', 'true' );
                }
            },
            {
                'name': 'Created By (dsc)', 'action': function() {
                    _sortData( 'createdBy', 'false' );
                }
            },
            {
                'name': 'Modified At (asc)', 'action': function() {
                    _sortData( 'lastModifiedAt', 'true' );
                }
            },
            {
                'name': 'Modified At (dsc)', 'action': function() {
                    _sortData( 'lastModifiedAt', 'false' );
                }
            },
            {
                'name': 'Modified By (asc)', 'action': function() {
                    _sortData( 'lastModifiedBy', 'true' );
                }
            },
            {
                'name': 'Modified By (dsc)', 'action': function() {
                    _sortData( 'lastModifiedBy', 'false' );
                }
            },
            /*{'name': 'Review ID (asc)', 'action':function(){ _sortData('id', 'true');}},
            {'name': 'Review ID (dsc)', 'action':function(){ _sortData('id', 'false');}},*/
            {
                'name': 'Map ID (asc)', 'action': function() {
                    _sortData( 'mapId', 'true' );
                }
            },
            {
                'name': 'Map ID (dsc)', 'action': function() {
                    _sortData( 'mapId', 'false' );
                }
            }/*,
    ...
    var _linkClickHandler = function( d ) {
        ...
        jobsBG.node().appendChild( thisbody );
